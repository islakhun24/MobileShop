...
public class MobilFilterAdapter extends RecyclerView.Adapter<MobilFilterAdapter.ViewHolder> implements Filterable {
    ...
    public MobilFilterAdapter(Context context, ArrayList<MobilModel> item, AdapterCallback callback) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_mobil_filter, parent, false); //memanggil layout list recyclerview
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            rl1 = (LinearLayout)itemView.findViewById(R.id.rl1);
