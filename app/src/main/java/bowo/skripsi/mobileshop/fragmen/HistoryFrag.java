...
import bowo.skripsi.mobileshop.adapter.TransaksiAdapter;
 ...
 */
public class HistoryFrag extends Fragment implements TransaksiAdapter.AdapterCallback {
    private ArrayList<TransaksiModel> transaksiModels= new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        transaksiAdapter = new TransaksiAdapter(getActivity(),transaksiModels,this);
        ...
        rvMobil.setAdapter(transaksiAdapter);
    ...
    private void getMobil() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET, API.TAMPIL_TRANSAKSI+"?username="+usname, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i<jsonArray.length(); i++){
                        ...
                        TransaksiModel mobilModel= new TransaksiModel();
                        ...
                        transaksiModels.add(mobilModel);

                    }
                    transaksiAdapter.notifyDataSetChanged();
                    if (transaksiModels.size()<1 || transaksiModels.isEmpty()){
